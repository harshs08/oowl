...
$(document).ready(function() {
  ...
  $('#hands-free-mode img').click( function() {
    ...
    { handsFreeMode = true;
        ...
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-left','-50%');
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-bottom','-100%');
        /*if ($(this).attr('alt') == 'rotate') {
        $(this).css('transform','rotate(90deg)');
        }
        */
      ...
      window.setInterval(function(){
        ...
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-left','-50%');
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-bottom','-100%');
                    clickNum++;
                  }
                   if(clickNum == 2){
          ...
          $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-left','-50%');
        $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-bottom','-100%');
                    clickNum++;
                  }
