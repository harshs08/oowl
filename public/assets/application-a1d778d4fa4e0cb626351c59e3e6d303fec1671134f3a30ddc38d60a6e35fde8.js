...
$(document).ready(function() {
  ...
  $('#hands-free-mode img').click( function() {
    ...
    { handsFreeMode = true;
        ...
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-left',left_margin);
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-top',top_margin);
        /*if ($(this).attr('alt') == 'rotate') {
        $(this).css('transform','rotate(90deg)');
        }
        */
            ...
            if (xhr.readyState == 4) {
                ...
                if(gesture.indexOf('right') >= 0){
                  ...
                  if(clickNum == 1){
                    ...
                    $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-left',left_margin);
                    $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-top',top_margin);
                    clickNum++;
                  }
                  if(clickNum == 2){
                    ...
                    $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-left',left_margin);
                    $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-top',top_margin);
                    clickNum++;
                  }
