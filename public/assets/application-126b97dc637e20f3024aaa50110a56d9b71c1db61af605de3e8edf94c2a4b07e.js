...
$(document).ready(function() {
  ...
  $('#hands-free-mode img').click( function() {
    ...
    { handsFreeMode = true;
        ...
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('position','absolute');
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('height','initial');
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('width','initial');
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('display','initial');
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-left',top_margin);
        $('#container > div:nth-child(1) > div:nth-child(1) > img').css('margin-top',bottom_margin);
        /*if ($(this).attr('alt') == 'rotate') {
        $(this).css('transform','rotate(90deg)');
        }
        */
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4) {
                ...
                if(gesture.indexOf('right') >= 0){
                  ...
                  $('#container > div:nth-child(1) > div:nth-child(2) > img').css('position','absolute');
                    $('#container > div:nth-child(1) > div:nth-child(2) > img').css('height','initial');
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('width','initial');
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('display','initial');
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-left',top_margin);
        $('#container > div:nth-child(1) > div:nth-child(2) > img').css('margin-bottom',bottom_margin);
                    clickNum++;
                  }
                   if(clickNum == 2){
                   $('#container > div:nth-child(1) > div:nth-child(3) > img').addClass('bigIMG');
                  $('#container > div:nth-child(1) > div:nth-child(3) > img').css('position','absolute');
                    $('#container > div:nth-child(1) > div:nth-child(3) > img').css('height','initial');
                  $('#container > div:nth-child(1) > div:nth-child(3) > img').css('width','initial');
                  $('#container > div:nth-child(1) > div:nth-child(3) > img').css('display','initial');
          $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-left',top_margin);
        $('#container > div:nth-child(1) > div:nth-child(3) > img').css('margin-bottom',bottom_margin);
                    clickNum++;
                  }
